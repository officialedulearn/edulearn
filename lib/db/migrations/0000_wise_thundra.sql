...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Chat" ADD CONSTRAINT "Chat_userAddress_User_address_fk" FOREIGN KEY ("userAddress") REFERENCES "public"."User"("address") ON DELETE no action ON UPDATE no action;
EXCEPTION
